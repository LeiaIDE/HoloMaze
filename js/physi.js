window.Physijs = (function() {
	...
	Physijs.Scene = function( params ) {
		...
		//Physijs.scripts.worker = 'https://holodevuserresource.s3.amazonaws.com/physijs_worker.js';
		...
		params = params || {};
		params.ammo = Physijs.scripts.ammo;// || 'https://holodevuserresource.s3.amazonaws.com/ammo.js';
