...
function initScene() {
    ...
    //var _zdpNormal = new THREE.Vector3(_ZDPNormal.x, _ZDPNormal.y, _ZDPNormal.z);
    //var _zdpCenter = new THREE.Vector3(_ZDPCenter.x, _ZDPCenter.y, _ZDPCenter.z);
    //camera = new LeiaCamera({
    //    dCtoZDP: _ZDPDistanceToCamera,
    //    zdpNormal: _zdpNormal,
    //    targetPosition: _zdpCenter
    //});
...
function render() {
    ...
    tMatlogo.makeTranslation(0, 15, -30);
    ...
    renderer.setClearColor(new THREE.Color().setRGB(0.0, 0.0, 1.0), 0.5);
  ...
  //  LEIA.virtualScreen.d -= 0.1;


   // LEIA.virtualScreen.width += 1.0;
   // LEIA.virtualScreen.center.x += 0.2;
    ...
    renderer._depCom.enable = false;
    // LEIA.virtualScreen.width = 800.0;
    //LEIA.virtualScreen.width = 400.0;
    //LEIA.virtualScreen.center = new THREE.Vector3(0, 50, 0);
    //LEIA.virtualScreen.normal = new THREE.Vector3(0.5, 1, 0 );
    //console.log("LEIA.virtualScreen: " + LEIA.virtualScreen.center.x + " " + LEIA.virtualScreen.center.y + " " + LEIA.virtualScreen.center.z);
    // console.log("LEIA.virtualScreen: " + LEIA.virtualScreen.width);

    //console.log("LEIA.virtualScreen: " + LEIA.virtualScreen.normal.x + " " + LEIA.virtualScreen.normal.y + " " + LEIA.virtualScreen.normal.z);
    //LEIA.virtualScreen.d = 200;
    // console.log("LEIA.virtualScreen: " + LEIA.virtualScreen.d);
    //LEIA.virtualScreen.disp = 50;
    // console.log("LEIA.virtualScreen: " + LEIA.virtualScreen.disp);
    //LEIA.virtualScreen.b = 4;
    //console.log("LEIA.virtualScreen: " + LEIA.virtualScreen.b);
