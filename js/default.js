...
var code = worker.toString();
 	...
 	function initScene() {
 	    ...
 	    renderer = new LeiaWebGLRenderer({ antialias: true,
     ...
     transparent: true
 	    ...
 	    //Logo
 		var logo_mat = Physijs.createMaterial(
          new THREE.MeshLambertMaterial({ map: THREE.ImageUtils.loadTexture('https://holodevuserresource.s3.amazonaws.com/leai_logo.png'), transparent: true, opacity: 1.0 }),
   //       new THREE.MeshLambertMaterial({ map: THREE.ImageUtils.loadTexture('images/leai_logo.png'), transparent: true, opacity: 1.0 }),
   //     new THREE.MeshLambertMaterial({ transparent: false, opacity: 0.5 }),
 		...
 		logo_1.position.y = 40;
 		logo_1.position.z = 10;
 		logo_1.position.x = 0//wall_thick / 2;
 		logo_1.rotation.x = -90;
 		//logo_1.receiveShadow = true;
 		scene.add(logo_1);
   ...
   //      new THREE.MeshLambertMaterial({ map: THREE.ImageUtils.loadTexture('https://holodevuserresource.s3.amazonaws.com/space_6.jpg'), transparent: true, opacity: 0.0 }),
 	...
 	function render() {
 	    ...
 	    var yaw = document.getElementById("yaw");
 	    frame++;
 	    var x_g = Number(pitch.innerText) * 25;
 	    var y_g = Number(roll.innerText) * 25;
 	    var z_g = Number(yaw.innerText) * -25;
