...
var m31=0;var m32=0;var m33=(f+n)/(n-f);var m34=2*f*n/(n-f);var m41=0;var m42=0;var m43=-1;var m44=0;camera.projectionMatrix.set(m11,m12,m13,m14,m21,m22,m23,m24,m31,m32,m33,m34,m41,m42,m43,m44)}return d};this._holoScreen=undefined;this.bHoloScreenInit=false;var CHoloScreen=function(camera,_sizeX,_near,_far){this.position=new THREE.Vector3(0,0,0);this.position.copy(camera.targetPosition);this.scale=1;var originSize=_sizeX;this.sizeX=_sizeX;var _length=this.sizeX/4;var geoTarRect=new THREE.PlaneGeometry(1*
_length*4,1*_length*3,1,1);var matTarRect=new THREE.MeshBasicMaterial({color:26282,transparent:true,opacity:0.2});matTarRect.side=THREE.DoubleSide;this.tarObj=new THREE.Mesh(geoTarRect,matTarRect);this.tarObj.name="tarPlane";this.tarObj.visible=true;this.tarObj.rotation.setFromRotationMatrix(camera.matrix);this.tarObj.position.set(this.position.x,this.position.y,this.position.z);this.tarObj.scale.x=this.scale;this.tarObj.scale.y=this.scale;this.tarObj.scale.z=this.scale;this.tarObj.updateMatrix();
var halfX=1*_length*2;var halfY=1*_length*1.5;var halfZ=1*_length*1.5;var vtx=[];this.auxBoxUpPlane=new THREE.Object3D;vtx.push(new THREE.Vector3(halfX,halfY,0));vtx.push(new THREE.Vector3(halfX,-halfY,0));vtx.push(new THREE.Vector3(-halfX,-halfY,0));vtx.push(new THREE.Vector3(-halfX,halfY,0));this.auxBoxDownPlane=new THREE.Object3D;vtx.push(new THREE.Vector3(halfX,halfY,0));vtx.push(new THREE.Vector3(halfX,-halfY,0));vtx.push(new THREE.Vector3(-halfX,-halfY,0));vtx.push(new THREE.Vector3(-halfX,
halfY,0));var matLine=new THREE.LineBasicMaterial({color:39219});var linePZ=[];for(var ii=0;ii<4;ii++){var linegeo=new THREE.Geometry;linegeo.vertices.push(vtx[ii],vtx[(ii+1)%4]);linePZ.push(new THREE.Line(linegeo,matLine));this.auxBoxUpPlane.add(linePZ[ii])}this.auxBoxUpPlane.name="UpPlane";var __point=new THREE.Vector3;__point.copy(camera.position.clone().sub(camera.targetPosition));var origin_dis=__point.length();if(_near==undefined)this.auxBoxUpPlane.position.z=halfZ;else this.auxBoxUpPlane.position.z=
origin_dis-_near;this.tarObj.add(this.auxBoxUpPlane);var lineNZ=[];for(var jj=0;jj<4;jj++){var linegeo=new THREE.Geometry;linegeo.vertices.push(vtx[jj+4],vtx[(jj+1)%4+4]);lineNZ.push(new THREE.Line(linegeo,matLine));this.auxBoxDownPlane.add(lineNZ[jj])}this.auxBoxDownPlane.name="DownPlane";if(_far==undefined)this.auxBoxDownPlane.position.z=-halfZ;else this.auxBoxDownPlane.position.z=origin_dis-_far;this.tarObj.add(this.auxBoxDownPlane);this.auxBoxEdges=new THREE.Object3D;var lineZZ=[];for(var kk=
0;kk<4;kk++){var linegeo=new THREE.Geometry;linegeo.vertices.push(this.auxBoxUpPlane.children[kk].geometry.vertices[0],this.auxBoxDownPlane.children[kk].geometry.vertices[0]);lineZZ.push(new THREE.Line(linegeo,matLine));this.auxBoxEdges.add(lineZZ[kk])}this.tarObj.add(this.auxBoxEdges);this.getData=function(){this.position.copy(this.tarObj.position);this.scale=this.tarObj.scale.x;this.sizeX=originSize*this.scale;this.tarObj.rotation.setFromRotationMatrix(camera.matrix);for(var ll=0;ll<4;ll++){this.auxBoxEdges.children[ll].geometry.verticesNeedUpdate=
...
halfY,0));vtx.push(new THREE.Vector3(halfX,-halfY,0));vtx.push(new THREE.Vector3(-halfX,-halfY,0));vtx.push(new THREE.Vector3(-halfX,halfY,0));var matLine=new THREE.LineBasicMaterial({color:6710784});var lineNear=[];for(var ii=0;ii<4;ii++){var linegeo=new THREE.Geometry;linegeo.vertices.push(vtx[ii],vtx[(ii+1)%4]);lineNear.push(new THREE.Line(linegeo,matLine));this.nearPlane.add(lineNear[ii])}this.nearPlane.name="nearPlane";this.holocamcenter.eyeCenter.add(this.nearPlane);this.farPlane=new THREE.Object3D;
vtx.push(new THREE.Vector3(halfX,halfY,0));vtx.push(new THREE.Vector3(halfX,-halfY,0));vtx.push(new THREE.Vector3(-halfX,-halfY,0));vtx.push(new THREE.Vector3(-halfX,halfY,0));var lineFar=[];for(var jj=0;jj<4;jj++){var linegeo=new THREE.Geometry;linegeo.vertices.push(vtx[jj+4],vtx[(jj+1)%4+4]);lineFar.push(new THREE.Line(linegeo,matLine));this.farPlane.add(lineFar[jj])}this.farPlane.name="farPlane";this.holocamcenter.eyeCenter.add(this.farPlane);this.frustum=new THREE.Object3D;var lineFrustum=[];
for(var kk=0;kk<4;kk++){var linegeo=new THREE.Geometry;linegeo.vertices.push(new THREE.Vector3(0,0,0),this.farPlane.children[kk].geometry.vertices[0]);lineFrustum.push(new THREE.Line(linegeo,matLine));this.frustum.add(lineFrustum[kk])}this.holocamcenter.eyeCenter.add(this.frustum);var ori_dis=this.holocamcenter.origin_dis;var p_z=this.holoscreen.auxBoxUpPlane.position.z*this.holoscreen.scale;var n_z=this.holoscreen.auxBoxDownPlane.position.z*this.holoscreen.scale;this.nearPlane.position.z=-1*(ori_dis-
p_z);this.farPlane.position.z=-1*(ori_dis-n_z);this.distanceNear=-1*this.nearPlane.position.z;this.distanceFar=-1*this.farPlane.position.z;this.farPlane.updateMatrix();this.getData=function(){var distanceZdp=new THREE.Vector3;distanceZdp.copy(this.holocamcenter.eyeCenter.position.clone().sub(this.holoscreen.tarObj.position));var cur_dis=distanceZdp.length();var p_z=this.holoscreen.auxBoxUpPlane.position.z*this.holoscreen.scale;var n_z=this.holoscreen.auxBoxDownPlane.position.z*this.holoscreen.scale;
this.nearPlane.position.z=-1*(cur_dis-p_z);this.farPlane.position.z=-1*(cur_dis-n_z);this.distanceNear=-1*this.nearPlane.position.z;this.distanceFar=-1*this.farPlane.position.z;var _scaleNear=this.holoscreen.scale*Math.abs(this.nearPlane.position.z)/cur_dis;var _scaleFar=this.holoscreen.scale*Math.abs(this.farPlane.position.z)/cur_dis;this.nearPlane.scale.x=_scaleNear;this.nearPlane.scale.y=_scaleNear;this.nearPlane.scale.z=_scaleNear;this.farPlane.scale.x=_scaleFar;this.farPlane.scale.y=_scaleFar;
this.farPlane.scale.z=_scaleFar;for(var ll=0;ll<4;ll++){this.frustum.children[ll].geometry.verticesNeedUpdate=true;var oldPsoition=new THREE.Vector3;oldPsoition.copy(this.farPlane.children[ll].geometry.vertices[0]);var matW=new THREE.Matrix4;matW=this.farPlane.matrix;oldPsoition.applyMatrix4(matW);this.frustum.children[ll].geometry.vertices[1]=oldPsoition}console.log("this.distanceNear",this.distanceNear);console.log("this.distanceFar",this.distanceFar)};this.setData=function(){this.nearPlane.position.z=
-1*this.distanceNear;this.farPlane.position.z=-1*this.distanceFar}};this.bGlobalViewInit=false;var _globalView;var CGlobalView=function(camera,scene,renderTarget,forceClear){var npart=8;this.camMeshs64=[];this.ObjMesh2=[];this.Gcamera=new THREE.PerspectiveCamera(90,_canvas.width/_canvas.height,0.01,4E4);this.init=function(){var vecCend=new THREE.Vector3(camera.position.x,camera.position.y,camera.position.z);var vecGT=new THREE.Vector3((camera.position.x+camera.targetPosition.x)/2,(camera.position.y+
camera.targetPosition.y)/2,(camera.position.z+camera.targetPosition.z)/2);vecCend.x-=vecGT.x;vecCend.y-=vecGT.y;vecCend.z-=vecGT.z;var vecUp=new THREE.Vector3(0,-vecCend.z,vecCend.y);var lengthVecUp=Math.sqrt(vecUp.x*vecUp.x+vecUp.y*vecUp.y+vecUp.z*vecUp.z);vecUp.x/=lengthVecUp;vecUp.y/=lengthVecUp;vecUp.z/=lengthVecUp;var __length=Math.sqrt(vecCend.x*vecCend.x+vecCend.y*vecCend.y+vecCend.z*vecCend.z);vecUp.x=vecUp.x*2.2*__length+vecGT.x;vecUp.y=vecUp.y*2.2*__length+vecGT.y;vecUp.z=vecUp.z*2.2*__length+
vecGT.z;this.Gcamera=new THREE.PerspectiveCamera(90,_canvas.width/_canvas.height,0.01,4E4);this.Gcamera.position.x=vecUp.x;this.Gcamera.position.y=vecUp.y;this.Gcamera.position.z=vecUp.z;this.Gcamera.up.x=vecCend.x;this.Gcamera.up.y=vecCend.y;this.Gcamera.up.z=vecCend.z;this.Gcamera.lookAt(new THREE.Vector3(vecGT.x,vecGT.y,vecGT.z));this.LocalControls=new dragControls(this.Gcamera);this.LocalControls.screen.left=0;this.LocalControls.screen.top=_canvas.height*(1-_that.GObserveView.bottom-_that.GObserveView.height);
this.LocalControls.screen.width=_canvas.width*_that.GObserveView.width;this.LocalControls.screen.height=_canvas.height*_that.GObserveView.height;this.camControls=new pickControls(this.Gcamera,undefined,_that._holoScreen.sizeX/15);this.camControls.view64fov=_that._holoCamCenter.fov;this.camControls.spanSphereMode=_that._holoCamCenter.spanSphereMode;this.camControls.screen.left=0;this.camControls.screen.top=_canvas.height*(1-_that.GObserveView.bottom-_that.GObserveView.height);this.camControls.screen.width=
...
undefined,_that._holoScreen.sizeX/15);this.upPlaneControls.screen.left=0;this.upPlaneControls.screen.top=_canvas.height*(1-_that.GObserveView.bottom-_that.GObserveView.height);this.upPlaneControls.screen.width=_canvas.width*_that.GObserveView.width;this.upPlaneControls.screen.height=_canvas.height*_that.GObserveView.height;this.downPlaneControls=new pickControls(this.Gcamera,undefined,_that._holoScreen.sizeX/15);this.downPlaneControls.screen.left=0;this.downPlaneControls.screen.top=_canvas.height*
(1-_that.GObserveView.bottom-_that.GObserveView.height);this.downPlaneControls.screen.width=_canvas.width*_that.GObserveView.width;this.downPlaneControls.screen.height=_canvas.height*_that.GObserveView.height;var camGeometry=new THREE.CylinderGeometry(0,__length/40,__length/20,20);camGeometry.applyMatrix((new THREE.Matrix4).makeRotationFromEuler(new THREE.Euler(Math.PI/2,Math.PI,0)));var camMaterial=new THREE.MeshNormalMaterial;var bHasCam=false;var obj,subObj,tarId;for(var _i=0,_l=scene.children.length;_i<
_l;_i++){obj=scene.children[_i];if(obj==camera)bHasCam=true}if(!bHasCam)for(var _ii=0,_ll=scene.children.length;_ii<_ll;_ii++){obj=scene.children[_ii];for(var _jj=0,lll=obj.children.length;_jj<lll;_jj++){subObj=obj.children[_jj];if(subObj==camera)tarId=_ii}}var spanM=_that._holoCamCenter.spanSphereMode;for(var i=0;i<npart;i++)for(var j=0;j<npart;j++){var mesh=new THREE.Mesh(camGeometry,camMaterial);var Gradient=new THREE.Vector3;var EachTarPos=new THREE.Vector3;var meshPosition=_that.getCameraPosition(camera.position,
camera.targetPosition,camera.up,npart,i,j,Gradient,EachTarPos,spanM);mesh.position.x=meshPosition.x;mesh.position.y=meshPosition.y;mesh.position.z=meshPosition.z;mesh.lookAt(EachTarPos);this.camMeshs64.push(mesh);if(bHasCam||tarId==undefined)scene.add(mesh);else scene.children[tarId].add(mesh);var meshSX=mesh.clone();var meshPosSX=_that.getCameraPosition(camera.position,camera.targetPosition,camera.up,npart,i,j,Gradient,EachTarPos,spanM,0.5,0);meshSX.position.x=meshPosSX.x;meshSX.position.y=meshPosSX.y;
meshSX.position.z=meshPosSX.z;meshSX.lookAt(EachTarPos);this.camMeshs64.push(meshSX);var meshSY=mesh.clone();var meshPosSY=_that.getCameraPosition(camera.position,camera.targetPosition,camera.up,npart,i,j,Gradient,EachTarPos,spanM,0,-0.5);meshSY.position.x=meshPosSY.x;meshSY.position.y=meshPosSY.y;meshSY.position.z=meshPosSY.z;meshSY.lookAt(EachTarPos);this.camMeshs64.push(meshSY);var meshSXY=mesh.clone();var meshPosSXY=_that.getCameraPosition(camera.position,camera.targetPosition,camera.up,npart,
i,j,Gradient,EachTarPos,spanM,0.5,-0.5);meshSXY.position.x=meshPosSXY.x;meshSXY.position.y=meshPosSXY.y;meshSXY.position.z=meshPosSXY.z;meshSXY.lookAt(EachTarPos);this.camMeshs64.push(meshSXY);if(bHasCam||tarId==undefined){scene.add(meshSX);scene.add(meshSY);scene.add(meshSXY)}else{scene.children[tarId].add(meshSX);scene.children[tarId].add(meshSY);scene.children[tarId].add(meshSXY)}if(_that.nShaderMode==0||(_that.nShaderMode==1||_that.nShaderMode==5)){meshSX.visible=false;meshSY.visible=false;meshSXY.visible=
false}}this.ObjMesh2.push(_that._holoCamCenter.eyeCenter);this.ObjMesh2.push(_that._holoScreen.tarObj);this.camControls.attach(this.ObjMesh2[0],false);this.tarControls.attach(this.ObjMesh2[1],false);this.upPlaneControls.attach(_that._holoScreen.auxBoxUpPlane,true);this.downPlaneControls.attach(_that._holoScreen.auxBoxDownPlane,true);this.ObjMesh2[0].visible=true;this.ObjMesh2[1].visible=true;if(bHasCam||tarId==undefined){scene.add(this.ObjMesh2[0]);scene.add(this.ObjMesh2[1]);scene.add(this.camControls);
scene.add(this.tarControls);this.tarControls.object.add(this.upPlaneControls);this.tarControls.object.add(this.downPlaneControls)}else{scene.children[tarId].add(this.ObjMesh2[0]);scene.children[tarId].add(this.ObjMesh2[1]);scene.children[tarId].add(this.tarControls);scene.children[tarId].add(this.camControls);this.tarControls.object.add(this.upPlaneControls);this.tarControls.object.add(this.downPlaneControls)}};this.init();this.update=function(){var spanMode=_that._holoCamCenter.spanSphereMode;var _left=
Math.floor(_canvas.width*_that.GObserveView.left);var _bottom=Math.floor(_canvas.height*_that.GObserveView.bottom);var _width=Math.floor(_canvas.width*_that.GObserveView.width);var _height=Math.floor(_canvas.height*_that.GObserveView.height);_that.setViewport(_left,_bottom,_width,_height);_that.setScissor(_left,_bottom,_width,_height);_that.enableScissorTest(true);_that.setClearColor((new THREE.Color).setRGB(0.11,0.12,0.18));this.Gcamera.aspect=_width/_height;this.Gcamera.updateProjectionMatrix();
...
_npart){var spanMode=_that._holoCamCenter.spanSphereMode;camera.updateMatrix();_that._holoCamCenter.eyeCenter.rotation.setFromRotationMatrix(camera.matrix);_that._holoCamCenter.eyeCenter.updateMatrix();var camPositionCenter=new THREE.Vector3(_that._holoCamCenter.eyeCenter.position.x,_that._holoCamCenter.eyeCenter.position.y,_that._holoCamCenter.eyeCenter.position.z);var tmpM=new THREE.Matrix4;var tmpV=new THREE.Vector3(camPositionCenter.x-camera.targetPosition.x,camPositionCenter.y-camera.targetPosition.y,
camPositionCenter.z-camera.targetPosition.z);var npart=8;if(_npart!==undefined)npart=_npart;var _d=0;if(shiftX==undefined)shiftX=0;if(shiftY==undefined)shiftY=0;_that._holoScreen.tarObj.rotation.setFromRotationMatrix(camera.matrix);_that._holoScreen.tarObj.updateMatrix();camera.near=_that._holoClipFrustum.distanceNear;camera.far=_that._holoClipFrustum.distanceFar;for(var ii=0;ii<npart;ii++)for(var jj=0;jj<npart;jj++){if(renderTarget!==undefined){_that.setViewport(renderTarget.width/npart*ii,renderTarget.height/
npart*jj,renderTarget.width/npart,renderTarget.height/npart);_that.setScissor(renderTarget.width/npart*ii,renderTarget.height/npart*jj,renderTarget.width/npart,renderTarget.height/npart)}else{_that.setViewport(_canvas.width/npart*ii,_canvas.height/npart*jj,_canvas.width/npart,_canvas.height/npart);_that.setScissor(_viewportWidth/npart*ii,_viewportHeight/npart*jj,_viewportWidth/npart,_viewportHeight/npart)}_that.enableScissorTest(true);var Gradient=new THREE.Vector3;var EachTarPos=new THREE.Vector3;
var camPosition=_that.getCameraPosition(camPositionCenter,camera.targetPosition,camera.up,npart,ii,jj,Gradient,EachTarPos,spanMode,shiftX,shiftY);camera.position.x=camPosition.x;camera.position.y=camPosition.y;camera.position.z=camPosition.z;tmpM.lookAt(camera.position,EachTarPos,camera.up);camera.quaternion.setFromRotationMatrix(tmpM);camera.updateMatrix();if(_that._holoScreen.tarObj.geometry.vertices[0]!==undefined)_d=_that.getCameraIntrinsic(camera,_that._holoScreen.tarObj,ii,jj);if(renderTarget!==
undefined){renderTarget.sx=renderTarget.width/npart*ii;renderTarget.sy=renderTarget.height/npart*jj;renderTarget.w=renderTarget.width/npart;renderTarget.h=renderTarget.height/npart}_that.render(scene,camera,renderTarget,forceClear)}camera.position.x=camPositionCenter.x;camera.position.y=camPositionCenter.y;camera.position.z=camPositionCenter.z;camera.up.set(0,1,0);if(tmpV.y>0&&(tmpV.y>=Math.abs(tmpV.x)*2&&tmpV.y>=Math.abs(tmpV.z)*2))camera.up.set(0,0,-1);camera.lookAt(camera.targetPosition)};this.stateData=
{};this.messageFlag=0;this.SetUpRenderStates=function(scene,camera,renderTarget,forceClear,holoScreenSize,holoCamFov,nearClip,farClip,messageFlag){var _holoCamFov=50;var _holoScreenScale=1;if(holoCamFov!==undefined)_holoCamFov=holoCamFov;var _holoScreenSize=100;if(holoScreenSize!==undefined)_holoScreenSize=holoScreenSize;if(camera.position.x==0&&(camera.position.y!=0&&camera.position.z==0))camera.position.z=camera.position.y/100;if(!this.bHoloCamCenterInit){this._holoCamCenter=new CHoloCamCenter(camera,
_holoCamFov);this.bHoloCamCenterInit=true;this.stateData._camFov=this._holoCamCenter.fov;this.stateData._camPosition=new THREE.Vector3(0,0,0);this.stateData._camPosition.copy(this._holoCamCenter.position)}if(!this.bHoloScreenInit&&camera.position.length()>=0){this._holoScreen=new CHoloScreen(camera,_holoScreenSize,nearClip,farClip);this.bHoloScreenInit=true;this.stateData._holoScreenScale=this._holoScreen.scale;this.stateData._holoScreenSize=this._holoScreen.sizeX;this.stateData._tarPosition=new THREE.Vector3(0,
...
parameters.scene;camera=parameters.camera}if(parameters.holoScreenSize==undefined)holoScreenSize=40;else holoScreenSize=parameters.holoScreenSize;if(parameters.holoCamFov==undefined)holoCamFov=50;else holoCamFov=parameters.holoCamFov;if(parameters.messageFlag==undefined){messageFlag=0;console.log("parameters.messageFlag not defined!")}else messageFlag=parameters.messageFlag;renderTarget=parameters.renderTarget;forceClear=parameters.forceClear;scene.overrideMaterial=null;this.SetUpRenderStates(scene,
camera,renderTarget,forceClear,holoScreenSize,holoCamFov,nearClip,farClip,messageFlag);if(this.bRendering){if(this.messageFlag!==0||this.messageFlag==0&&(this.bGlobalView==false&&this.bGyroSimView==false))if(0==this._renderMode)Leia_compute_renderViews(scene,camera,renderTarget,forceClear,0,0,1);else if(1==this._renderMode){Leia_compute_renderViews(scene,camera,renderTarget,forceClear);if(this.nShaderMode==2||(this.nShaderMode==3||this.nShaderMode==4)){Leia_compute_renderViews(scene,camera,renderTarget,
forceClear,0.5,0);Leia_compute_renderViews(scene,camera,renderTarget,forceClear,0,-0.5);Leia_compute_renderViews(scene,camera,renderTarget,forceClear,0.5,-0.5)}}else if(2==this._renderMode){Leia_compute_renderViews(scene,camera,this._shaderManager._swizzleRenderTarget,forceClear);if(this.nShaderMode==1||this.nShaderMode==2){Leia_compute_renderViews(scene,camera,this._shaderManager._swizzleRenderTargetSftX,forceClear,0.5,0);Leia_compute_renderViews(scene,camera,this._shaderManager._swizzleRenderTargetSftY,
